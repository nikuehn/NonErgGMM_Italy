...
knitr::opts_chunk$set(echo = TRUE, fig.width=8, fig.asp = 0.8, out.width = '50%', fig.show="hold",
                      fig.path = 'pictures/',
                      root.dir = '/Users/nico/GROUNDMOTION/PROJECTS/NONERGODIC/ITALY/WriteUp')
```
...
```{r plot-data-1, fig.cap = "Scatterplot of Joyner-Boore distance and magnitude, and map of events and stations.", warning=FALSE}
ggplot() +
...
```{r plot-data, fig.cap = "Scatterplot of PGA vs magnitude and Joyner-Boore distance."}
ggplot() +
...
``` {r make-mesh, cache = TRUE, out.width = '75%', fig.cap = "Mesh used for spatial INLA models."}
co_eq <- utm_ev/1000
co_stat <- utm_st/1000
...
``` {r spatial-constant-eq, cache = TRUE}
...
``` {r spatial-constant-stat, cache = TRUE}
...
``` {r posterior-linr, fig.cap = "Posterior distribution of linear R coefficient."}
...
``` {r posterior-phi, fig.cap = "Posterior distribution of phi for different models."}
...
``` {r posterior-tau, fig.cap = "Posterior distribution of tau for different models."}
...
``` {r posterior-phis2s, fig.cap = "Posterior distribution of phi_S2S for different models."}
...
``` {r posterior-range-eq, fig.cap = "Posterior distribution of spatial range of event constant for different models."}
...
``` {r posterior-range-stat, fig.cap = "Posterior distribution of spatial range of station constant for different models."}
...
``` {r posterior-range-gs, fig.cap = "Posterior distribution of spatial range of geometrical spreading terms for different models."}
...
``` {r model-comp-fixed, fig.cap = "Comparison of fixed effects.", out.width = '100%', fig.width=16}
...
``` {r model-comparison-cv, cache = TRUE, warning = FALSE, message = FALSE}
...
``` {r plot-inla-idxeq, out.width = '100%', fig.width=16}
...
``` {r plot-inla-idxgs, out.width = '100%', fig.width=16}
...
``` {r plot-inla-idxgs-2, out.width = '100%', fig.width=16}
...
``` {r plot-inla-idxlinr, out.width = '100%', fig.width=16, fig.asp = 1.2}
...
``` {r plot-inla-idxlinr-2, out.width = '100%', fig.width=16}
...
``` {r plot-inla-idxvs, out.width = '100%', fig.width=16}
...
``` {r plot-inla-idxvs-2, out.width = '100%', fig.width=16}
...
``` {r comparison-cell, out.width = '100%', fig.width=16}
...
```{r prediction-fit-full, cache=TRUE}
...
```{r prediction-fit-cell, cache=TRUE}
...
```{r prediction-fit-cell2, cache=TRUE}
...
``` {r prediction-plot, out.width = '100%', fig.width=16}
...
``` {r prediction-plot-cell2, out.width = '100%', fig.width=16}
df_plot_c <- as.data.frame(cbind(data_pred$EQID, data_pred$WESN, data_pred$JB_complete,
                                 pred_spatial_cell))
...
``` {r prediction-plot-sd, out.width = '100%', fig.width=16}
